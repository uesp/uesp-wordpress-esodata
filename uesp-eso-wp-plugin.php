...
class CUespEsoWordPressPlugin
{
	...
	public static function EnqueueResources()
	{
		...
		wp_enqueue_script( 'uespesoskills', plugin_dir_url(__FILE__) . 'scripts/esoskills.js', array( 'jquery' ), "6.3.10" );
		wp_enqueue_script( 'uespesodata', plugin_dir_url(__FILE__) . 'scripts/esodata.js', array( 'jquery' ), "6.3.10" );
	}
